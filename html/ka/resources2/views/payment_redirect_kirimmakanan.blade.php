...
<body>
    <div class="card">
        <div class="card-header">
            ...
            @else
            <h2 class="card-title failed-text">
                Pembayaran Gagal!
            </h2>
            @endif
        ...
        <div class="card-body">
            ...
            <h4 class="mt-0 mb-1">Rincian Pesanan</h4>
            <ol class="list-item">
                <li>
                    <div>
                    <a href="#">{{ $booking->shipment_name }} ({{ $booking->shipment_phone }})</a>
                    </div>
                </li>
                <li>
                    <div>
                        <a href="#">{{ $booking->shipment_address }} - {{ $booking->shipment_city }}</a>
                    </div>
                </li>
            </ol>
            ...
            <ol class="list-item">
                ...
                <li>
                    <div>
                    <a href="#">{{ $item->product->name }}<br>({{ number_format($item->product->price) }} @ {{ $item->quantity }})</a>
                    </div>
                </li>
                @endforeach
            </ol>
            ...
            <ol class="list-item">
                <li>
                    <div style="clear: both;">
                        ...
                        <a href="#" style="float: right;">
                           IDR. {{ number_format($booking->total_cost) }}
                        </a>
                    </div>
                </li>
                <li>
                    <div style="clear: both;">
                        ...
                        <a href="#" style="float: right;">
                           IDR. {{ number_format($booking->shipment_cost) }}
                        </a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div style="clear: both;">
                        ...
                        <a href="#" style="float: right;">
                            IDR. {{ number_format($booking->total_cost + $booking->shipment_cost) }}
                        </a>
                    </div>
                </li>
            </ol>

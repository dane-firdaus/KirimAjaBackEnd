...
<div align="center">
    ...
    <p align="center" style="margin-top: 75px;margin-bottom: 75px;">
        <img src="<?php echo $url.'/assets/logo-invoice.png';?>">
    </p>
    <div style="margin-top:50px;height:127px;margin-left:-8px;margin-right:-8px;background-image: url('<?php echo $url.'/assets/bg-invoice.jpg';?>');border:1px solid #d7d7d7;">
    ...
    <table class='rg-table'>
        ...
        <tr>
            ...
            <td class='text descp' colspan="2">
                ...
                <table style="margin-left:-5px">
                    ...
                    <tr>
                        <td>Weight</td>
                        <td><?php echo $detail->package_weight; ?> Kg</td>
                    </tr>
                    <tr>
                        <td>Origin</td>
        ...
        <tr>
            ...
            <td class='text'>IDR <?php echo number_format($result->payment->transaction_amount,2);?></td>
        </tr>
        <tr>
            <td class='spacing'></td>
            <td colspan="3">
        ...
        <tr>
            ...
            <td class='text'><b>IDR <?php echo number_format($total,2);?></b></td>
        </tr>
        <tr>
            <td class='spacing'></td>
            <td colspan="3"><br></td>
            ...
            <td colspan="3" class='text descp'>
                <table cellspacing="5" cellpadding="10">
                    ...
                    <tr>
                        ...
                        <td style="color:#000000;text-align:center"><?php echo number_format($detail->package_weight,2); ?> </td>
                        <td style="color:#000000;text-align:center"><?php echo number_format($detail->package_volume,2); ?> </td>
                        <td style="color:#000000;text-align:center"><?php echo number_format($detail->package_weight,2); ?></td>
                    </tr>

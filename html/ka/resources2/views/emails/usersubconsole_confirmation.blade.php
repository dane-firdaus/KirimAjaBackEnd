                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit;/* text-align: center */">
                                                                                                    ...
                                                                                                    <span style="color: #000000; font-size: 14px; font-family: arial,helvetica,sans-serif">
                                                                                                                        Selamat!<br/>
                                                                                                                        Permintaan Anda untuk menjadi SubConsole KirimAja sudah kami verifikasi.  <br/>
                                                                                                                        Cek <a href="https://kirimaja.id/faq">FAQ</a> untuk mengetahui informasi detil terkait hak dan kewajiban SubConsole KirimAja. <br/>
                                                                                                                        Silakan untuk melakukan log-out terlebih dahulu, dan kemudian melakukan log-in kembali untuk dapat menikmati fitur SubConsole.<br/>
                                                                                                                        <br/><br/>
                                                                                                                        Ayo ajak Sohib di sekitar untuk mengantarkan paket ke tempat Anda
                                                                                                                        </span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>

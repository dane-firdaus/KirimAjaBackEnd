                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        ...
                                                                                                                                        Silakan klik tombol di bawah untuk melakukan perubahan password.</span>
                                                                                                                                </div>
                                                                                                                                {{-- <div
                                                                                                                                     style="font-family: inherit; text-align: center">
                                                                                                                                    <span
                                                                            ...
                                                                            <div data-role="module-unsubscribe"
                                                                                ...
                                                                                <div class="Unsubscribe--addressLine">
                                                                                    ...
                                                                                    <p
                                                                                        style="font-size:12px; line-height:20px;">
                                                                                        <span
                                                                                            class="Unsubscribe--senderAddress">Aerojasa
                                                                                            Logistics</span>,
                                                                                        <span
                                                                                            class="Unsubscribe--senderCity">Jakarta
                                                                                            Selatan</span>,
                                                                                        <span
                                                                                            class="Unsubscribe--senderState">DKI
                                                                                            Jakarta</span>
                                                                                        <span
                                                                                            class="Unsubscribe--senderZip">11111</span>
                                                                                    </p>
                                                                                </div>
                                                                                {{-- <p
																					style="font-size:12px; line-height:20px;">

                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        ...
                                                                                                                                        Terima kasih telah menjadi Sohib KirimAja, mohon melakukan verifikasi email anda terlebih dahulu.</span>
                                                                                                                                </div>
                                                                                                                                {{-- <div
                                                                                                                                     style="font-family: inherit; text-align: center">
                                                                                                                                    <span
                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td align="center"
                                                                                                                                            ...
                                                                                                                                            <a href="{{ $verify_link ?? '' }}"
                                                                                                                                               style="background-color:#314251; border:1px solid #314251; border-color:#314251; border-radius:0px; border-width:1px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                                                                                               target="_blank">Verifikasi email</a>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>

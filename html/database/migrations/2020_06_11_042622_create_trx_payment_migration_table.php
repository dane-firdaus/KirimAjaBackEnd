...
class CreateTrxPaymentMigrationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trx_payment_migration', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trx_payment_migration');
    }
}

...
class CreateTrxBookingCorporateTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trx_booking_corporate', function (Blueprint $table) {
            $table->id();
            $table->integer('corporate_id');
            $table->integer('corporate_user_id');
    ...
    {
        Schema::dropIfExists('trx_booking_corporate');
    }
}

...
class CreateTrxBookingDetailMigrationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trx_booking_detail_migration', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trx_booking_detail_migration');
    }
}

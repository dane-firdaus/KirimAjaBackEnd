                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        ...
                                                                                                                                        Kami telah menerima permintaan lupa PIN untuk akun KirimAja kamu.<br><br>Jika permintaan ini bukan dari kamu langsung, mohon melupakan email ini dan segera mengganti kata sandi akun kamu.<br><br>Berikut token PIN untuk melakukan reset.</span>
                                                                                                                                </div>
                                                                                                                                {{-- <div
                                                                                                                                     style="font-family: inherit; text-align: center">
                                                                                                                                    <span
                                                                                                                                          style="color: #314251; font-size: 18px"><strong>Terima kasih</strong></span>
                                                                                                                                </div> --}}
                                                                                                                                <div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td align="center"
                                                                                                                                            ...
                                                                                                                                            <p style="background-color:#314251; border:1px solid #314251; border-color:#314251; border-radius:0px; border-width:1px; color:#ffffff; display:inline-block; font-size:18px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit; letter-spacing:6px;"
                                                                                                                                               target="_blank">{{$token ?? '123456'}}</p>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            <a href="https://sendgrid.com/"
                                                                                                               ...
                                                                                                               target="_blank">KIRIMAJA • POWERED BY GARUDA INDONESIA GROUP</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>

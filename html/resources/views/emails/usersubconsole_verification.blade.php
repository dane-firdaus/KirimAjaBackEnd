                                                                                                            ...
                                                                                                            <td style="padding:18px 30px 18px 30px;line-height:22px;text-align:inherit;background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                                                                <div>
                                                                                                                    <div style="font-family: inherit;/* text-align: center */">
                                                                                                                            ...
                                                                                                                            <b style="color:#e74848">CONFIDENTIAL-Do not share this email</b><br/>

                                                                                                                    <br>Hi {{ $nama ?? '' }}</br>, kami telah menerima permintaan Forgot Password kamu.<br> Silahkan untuk melakukan Login dengan password berikut:<b>{{$verify_link}}</b>
                                                                                                                            </span><br>
                                                                                                                        <span style="color: #000000; font-size: 14px; font-family: arial,helvetica,sans-serif">
                                                                                                                                Jika kamu tidak membuat permintaan Forgot Password, mohon abaikan email ini.</span>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                            ...
                                                                                                            <td style="padding:18px 30px 18px 30px;line-height:22px;text-align:inherit;background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                                                                <div>
                                                                                                                    <div style="font-family: inherit;">
                                                                                                                        ...
                                                                                                                        <span style="color: #000000; font-size: 14px; font-family: arial,helvetica,sans-serif">Salam,<br>
                                                                                                                        KirimAja
                                                                                                                        <br>
                                                                                                                            <br><i>
                                                                                                                            This email is generated by system. KirimAja do not have any access or knowledge to password within this email. KirimAja do not hold responsible if this email is distributed to any other party.</i>
                                                                ...
                                                                <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe" style="color:#444444; font-size:12px; line-height:20px; padding:16px 16px 16px 16px; text-align:Center;" data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5">
                                                                    <div class="Unsubscribe--addressLine">
                                                                        ...
                                                                        <p style="font-size:12px; line-height:20px;">
                                                                            <span class="Unsubscribe--senderAddress">PT Aerojasa
                                                                                Cargo</span>,
                                                                            <span class="Unsubscribe--senderCity">Jl. Prof. Dr. Soepomo SH No. 45 Tebet</span>,
                                                                            <span class="Unsubscribe--senderState">Jakarta Selatan</span>,
                                                                            <span class="Unsubscribe--senderZip">Indonesia</span>
                                                                        </p>
                                                                    </div>
                                                                    {{-- <p style="font-size:12px; line-height:20px;">
                                                                        <a class="Unsubscribe--unsubscribeLink" href="{{{unsubscribe}}}" target="_blank" style="">Unsubscribe</a> - <a href="{{{unsubscribe_preferences}}}" target="_blank" class="Unsubscribe--unsubscribePreferences" style="">Unsubscribe
                                                                        Preferences</a></p> --}}
                                                                </div>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="center" bgcolor="#f5f8fd" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                                <a href="" style="background-color:#f5f8fd; border:1px solid #f5f8fd; border-color:#f5f8fd; border-radius:25px; border-width:1px; color:#a8b9d5; display:inline-block; font-size:10px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:5px 18px 5px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:helvetica,sans-serif;" target="_blank">KIRIMAJA •&nbsp;POWERED BY GARUDA INDONESIA GROUP</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>

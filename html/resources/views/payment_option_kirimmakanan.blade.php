    ...
    <div class="container">
        ...
        <div class="card mt-2 vitrual-account-info" hidden>
            ...
            <a href="#">
                <div class="item">
                    <div class="item-text">
                        <form id="proofForm" action="payment/notify?bookingId={{ $bookingId }}" method="POST" enctype="multipart/form-data">
                            <!-- <button>Upload Bukti Bayar</button> -->
                            <button id="uploadFile" class="fancy-button pop-onhover bg-gradient1"><span>Upload Bukti Bayar</span></button>
                            <button id="storeFile" class="fancy-button pop-onhover bg-gradient2" type="submit" hidden><span>Simpan</span></button>

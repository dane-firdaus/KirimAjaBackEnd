...
Route::get('tocwallet', ['uses' => 'UserController@walletTermsConditions']);
Route::get('banner', ['uses' => 'MasterController@bannerImage']);
...
Route::match(['GET', 'POST', 'DELETE'], 'me/addresspickup', ['uses' => 'UserController@userAddressPickup']);
...
Route::get('testAuthKaspro', ['uses' => 'MasterController@testAuthKaspro']);
Route::get('testGetToken', ['uses' => 'MasterController@testGetToken']);
...
Route::post('me/wallet/change-pin', ['uses' => 'UserController@changePIN']);
Route::post('me/wallet/validate', ['uses' => 'UserController@walletAccountValidate']);
Route::post('me/wallet/activation', ['uses' => 'UserController@walletActivation']);
...
Route::post('me/identity/base64', ['as' => 'identityPhoto', 'uses' => 'UserController@identityPhotobase64']); // identity with base64 - ABI
Route::get('me/identity/base64/{type}', ['as' => 'identityPhoto', 'uses' => 'UserController@identityPhotobase64']); // identity with base64 - ABI
...
Route::get('user/profilebase64', ['uses' => 'UserController@userProfileImagebase64']);
...
Route::group(['prefix' => 'guest'], function () {
    ...
    Route::post('check-tarif', ['uses' => 'CustomerController@getCheckTarif']);
...
Route::group(['prefix' => 'booking'], function () {
    ...
    Route::post('rate-service', ['uses' => 'BookingController@getPriceService']);
    ...
    //Phase#2Week#1 - Bayu - START
    Route::get('my-pickup', ['uses' => 'BookingController@myBookingPickup']);
    Route::post('find-pickup', ['uses' => 'BookingController@findMyBookingPickup']);
    //Phase#2Week#1 - Bayu - END
});
...
Route::group(['prefix' => 'payment'], function () {
    ...
    Route::post('walletpayment', ['uses' => 'UserController@walletPayment']); //20210428
    ...
    Route::get('generateConnote', ['uses' => 'PaymentController@autorunGenerateConnote']);
});
...
Route::group(['prefix' => 'master'], function () {
    ...
    //Phase#2Week#1 - Bayu - START
    Route::get('schedulepickup', ['uses' => 'MasterController@getSchedulePickup']);
    //Phase#2Week#1 - Bayu - END
    //Route::post('promos', ['uses' => 'MasterController@getPromo']);
    Route::post('kecamatanpickup', ['uses' => 'MasterController@getKecamatanPickup']);
    Route::post('jadwalpickup', ['uses' => 'MasterController@getJadwalPickup']);

    Route::post('geteligiblevoucher', ['uses' => 'MasterController@getVoucherByUser']);
});
...
Route::group(['prefix' => 'partners'], function () {
    ...
    Route::get('listBranch', ['uses' => 'APIPartnersController@getMasterAJCBranch']); //20210309 - TID: LKBlpC6c - START
});

 // t10 upload ktp swa usersubconsole
...
Route::group(['prefix' => 'backoffice'], function () {
    ...
    Route::match(['GET', 'POST'], 'table-voucher-datatable', ['uses' => 'APIBackoffice@tablevoucherDatatable']);
    ...
    Route::match(['GET', 'POST'],'rpt-perf', ['uses' => 'APIBackoffice@rpt_perf']);  //202105 - TID: DdGsOtgp - START

    Route::get('detail-voucher-code-report', ['uses' => 'APIBackoffice@rpt_perf_ByVoucherCode']); // t10 voucher detail pop up

    Route::post('assignCourier', ['uses' => 'APIBackoffice@assignCourier']);
    Route::post('updatePickup', ['uses' => 'APIBackoffice@updatePickup']);
    //20210323 - TID: U9LgjemB - KIBAR
    Route::get('dataDynamicLink', ['uses' => 'APIBackoffice@getDataDynamicLink']);
    Route::post('createDynamicLink', ['uses' => 'APIBackoffice@createDataDynamicLink']);
    Route::post('deleteDynamicLink', ['uses' => 'APIBackoffice@deleteDynamicLink']);
    Route::post('editDynamicLink', ['uses' => 'APIBackoffice@editDynamicLink']);
    Route::get('cityhubdomestic', ['uses' => 'APIBackoffice@citydomestic']);

    Route::get('users_export', ['uses' => 'APIBackoffice@getDataUser']);
    Route::post('users_campaign_export', ['uses' => 'APIBackoffice@getDataUserByCampaign']);
    Route::match(['GET', 'POST'],'rpt-perf2', ['uses' => 'APIBackoffice@rpt_perf2']);

    Route::get('external', ['uses' => 'APIBackoffice@external','as' => 'external']);
    Route::post('tambahexternal', ['uses' => 'APIBackoffice@addexternal','as' => 'BackofficeAddExternal']);
    Route::post('external_transaction', ['uses' => 'APIBackoffice@ExternalTransaction', 'as' => 'BackofficeExternalTransaction']);
    Route::post('external_event', ['uses' => 'APIBackoffice@ExternalEvent', 'as' => 'BackofficeExternalEvent']);

    Route::match(['GET', 'POST'], 'purpose', ['uses' => 'APIBackoffice@purpose']);
    Route::match(['GET', 'POST'], 'subpurpose', ['uses' => 'APIBackoffice@subpurpose']);

    Route::match(['GET', 'POST'], 'masterkomisi', ['uses' => 'APIBackoffice@masterkomisi']);
    Route::match(['GET', 'POST'], 'table-user-datatable', ['uses' => 'APIBackoffice@getDatatableUser']);

    Route::match(['GET', 'POST'], 'getdokustatus', ['uses' => 'APIBackoffice@checkPaymentStatus']);
    Route::match(['GET', 'POST'], 'gettransidbybooking', ['uses' => 'APIBackoffice@getTransIdByCode']);
    Route::get('findInvoiceTroubleshootAll', ['uses' => 'APIBackoffice@FindconnoteInvoiceTroubleshootAll']);
});

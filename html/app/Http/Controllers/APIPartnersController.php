...
//        if($booking->user_id == '36340' && $parameter['deliveryPoint'] <> '800017')
        ...
        {
            return response()->json(['message' => 'Invalid Drop-point for Cheona'], 406);
        }
        //cheona - staging
        //kahago - staging
        if($booking->user_id == '36434' && ($parameter['deliveryPoint'] <> '800068' && $parameter['deliveryPoint'] <> '800067' && $parameter['deliveryPoint'] <> '800066' && $parameter['deliveryPoint'] <> '800134' && $parameter['deliveryPoint'] <> '800130'  && $parameter['deliveryPoint'] <> '800011' && $parameter['deliveryPoint'] <> '800010' && $parameter['deliveryPoint'] <> '800010'  || $parameter['deliveryPoint'] <> '800125' ))
        {
            return response()->json(['message' => 'Invalid Drop-point for KAHAGO'], 406);
        }
        //kahago - staging
        ...
        $payment->transaction_total_amount = ($totalCost - $payment->transaction_comission_amount) + ($payment->transaction_tax);
        $payment->save();
